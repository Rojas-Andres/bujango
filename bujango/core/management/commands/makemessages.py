...
from bujango.core.management.utils import (
    find_command,
    handle_extensions,
    is_ignored_path,
    popen_wrapper,
...
from bujango.utils.jslex import prepare_js_for_gettext
from bujango.utils.regex_helper import _lazy_re_compile
from bujango.utils.text import get_text_list
from bujango.utils.translation import templatize
...
class Command(BaseCommand):
    ...
    def copy_plural_forms(self, msgs, locale):
        ...
        """
        django_dir = os.path.normpath(os.path.join(os.path.dirname(bujango.__file__)))
        if self.domain == "djangojs":
