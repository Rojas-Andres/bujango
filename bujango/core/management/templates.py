...
from bujango.template import Context, Engine
from bujango.utils import archive
from bujango.utils.http import parse_header_parameters
...
class TemplateCommand(BaseCommand):
    ...
    :param style: A color style object (see bujango.core.management.color).
        ...
        context = Context(
            {
                **options,
                ...
                "django_version": bujango.__version__,
            },
            autoescape=False,
        )
    ...
    def handle_template(self, template, subdir):
        ...
        Use bujango.__path__[0] as the default because the Django install
        directory isn't known.
        """
        if template is None:
            return os.path.join(bujango.__path__[0], "conf", subdir)
        else:
    ...
    def download(self, url):
        ...
        opener = build_opener()
        opener.addheaders = [("User-Agent", f"Django/{bujango.__version__}")]
        try:
