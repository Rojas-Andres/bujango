...
from bujango.utils.html import conditional_escape, escape, format_html
from bujango.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from bujango.utils.html import strip_spaces_between_tags
...
class URLNode(Node):
    ...
    def render(self, context):
        from bujango.urls import NoReverseMatch, reverse
