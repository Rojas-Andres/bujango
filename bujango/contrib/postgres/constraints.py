...
from bujango.contrib.postgres.indexes import OpClass
from bujango.core.exceptions import ValidationError
from bujango.db import DEFAULT_DB_ALIAS, NotSupportedError
from bujango.db.backends.ddl_references import Expressions, Statement, Table
from bujango.db.models import BaseConstraint, Deferrable, F, Q
from bujango.db.models.expressions import Exists, ExpressionList
from bujango.db.models.indexes import IndexExpression
from bujango.db.models.lookups import PostgresOperatorLookup
        ...
        *,
        ...
        if self.opclasses:
            warnings.warn(
                ...
                "bujango.contrib.postgres.indexes.OpClass in "
