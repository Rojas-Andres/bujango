...
from bujango.db.models.expressions import CombinedExpression, register_combinable_fields
from bujango.db.models.functions import Cast, Coalesce
...
class SearchQueryCombinable:
    ...
    # it's consistent with other usage in bujango.
