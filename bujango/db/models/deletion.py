...
from bujango.db import IntegrityError, connections, transaction
from bujango.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("bujango.db.models.SET", (value,), {})
