"""
MySQL database backend for bujango.

Requires mysqlclient: https://pypi.org/project/mysqlclient/
"""
from bujango.core.exceptions import ImproperlyConfigured
from bujango.db import IntegrityError
from bujango.db.backends import utils as backend_utils
...
class DatabaseWrapper(BaseDatabaseWrapper):
    ...
    def get_new_connection(self, conn_params):
        ...
        # mysqlclient 2.1 becomes the minimal mysqlclient supported by bujango.
