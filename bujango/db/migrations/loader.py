...
from bujango.db.migrations.graph import MigrationGraph
...
class MigrationLoader:
    ...
    inherit from bujango.db.migrations.Migration. See
    bujango.db.migrations.migration for what that looks like.
